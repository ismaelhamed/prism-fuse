...
namespace Microsoft.Practices.Prism.Commands
{
    ...
    public class CompositeCommand : ICommand
    {
        ...
        /// </summary>
        ///  <remarks>
        /// If this command is set to monitor command activity, and <paramref name="command"/> implements the <see cref="IActiveAware"/> interface, 
        /// this method will subscribe to its <see cref="IActiveAware.IsActiveChanged"/> event.
        /// </remarks>
        ...
        /// <returns>A <see cref="bool"/> value indicating whether the command should be used when evaluating <see cref="CompositeCommand.CanExecute"/> and <see cref="CompositeCommand.Execute"/>.</returns>
        /// <remarks>
        /// If this command is set to monitor command activity, and <paramref name="command"/> implements the <see cref="IActiveAware"/> interface, 
        /// this method will return <see langword="false" /> if the command's <see cref="IActiveAware.IsActive"/> property is <see langword="false" />; 
